<template>
      <section class="tool-panel">
        <h3>Tool</h3>
        <button type="button" @click="toolSelected = 'eraser'" :class="{ 'use-tool': toolSelected === 'eraser' }">Eraser</button>
        ...
        <button type="button" @click="toolSelected = 'pencil'" :class="{ 'use-tool': toolSelected === 'pencil' }">Pencil</button>
      </section>
